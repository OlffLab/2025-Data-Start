...
#---------------------------02 Load libraries required in this script----------------
# -----------------------------plus the ones you use all the time--------------------
...
#------------------------------1) Function read_gsheetsDB --------------------------
### to read specific sheets from a gsheets database or the whole database
# 
# Usage examples: 
#
...
## -----------------------Function gsheets_auth  ----------------------------
# to authenticate googlesheets4 package
# Usage examples:
# gsheets_auth(mode = "user") # interactively pick a Google account in your browser
# to automatically authenticate for a particular account, 
# add a file .Renviron to the
# root of your R project with the following line: 
# GS_EMAIL=your.name@rug.nl  # so your email that you want to authenticate
